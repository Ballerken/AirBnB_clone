...
import unittest
import inspect
import datetime as DT  # Added alias DT
...
class TestBaseModel(unittest.TestCase):
    ...
    def test_updated_at_type(self) -> None:
        ...
        self.assertEqual(type(self.base1.created_at), DT.datetime)
...
class TestInstantiationFromDict(unittest.TestCase):
    ...
    def test_updated_at_type_from_dict(self) -> None:
        ...
        self.assertEqual(type(new_base.updated_at), DT.datetime)
    ...
    def test_created_at_type_from_dict(self) -> None:
        ...
        self.assertEqual(type(new_base.created_at), DT.datetime)
